...
describe("PHP Integration", () => {
  it("should render a complete PHP application", () => {
    ...
    const composerFile = findFile(result, "blog-system/composer.json");
    expect(composerFile).toBeDefined();

    // Verify User model
    const userFile = findFile(result, "blog-system/src/Models/User.php");
    ...
    // Verify Post model
    const postFile = findFile(result, "blog-system/src/Models/Post.php");
    ...
    // Verify interface
    const serviceFile = findFile(
      result,
      "blog-system/src/Services/BlogServiceInterface.php",
    );
    expect(serviceFile).toBeDefined();
    expect(serviceFile!.contents).toContain("interface BlogServiceInterface");
    expect(serviceFile!.contents).toContain(
      "public abstract function createPost",
    );
  });
});
